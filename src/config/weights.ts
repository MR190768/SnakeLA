export const config = {
  ...
  WEIGHT_HEAD_ATTACK: parseFloat(process.env.WEIGHT_HEAD_ATTACK || '8.0'),
  WEIGHT_HEAD_AVOIDANCE: parseFloat(process.env.WEIGHT_HEAD_AVOIDANCE || '-20.0'),
  WEIGHT_TAIL_CHASE: parseFloat(process.env.WEIGHT_TAIL_CHASE || '20.0'),
